...
class NavigationManager:
    ...
    def is_still_moving(self, prim_path):
        return Utils.length3(Utils.sub3(self.character_manager.get_character_future_pos(prim_path),self.character_manager.get_character_current_pos(prim_path))) > 10
    ...
    def generate_path(self, coords, path_target_rot = None):
        ...
        print(f"Points is {self.path_points}")
        if path_target_rot:
